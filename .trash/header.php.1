					...
					<div class="col-12">
						<marquee behavior="scroll" direction="left" scrollamount="3" onmouseover="this.stop();"
							...
							<!-- <p>*For Super Bike there is Security
								...
								<p>Notice from GO ON Riders, GO ON riders is not responsible if a 'vehicle on rent' violates any lockdown rule imposed by the government.Only the customer should bear all the consequences if they violates the lockdown rules. Go On riders requests to all customers to kindly follow the lockdown rules imposed by Govt.,stay safe and Thanks for choosing GoOnRiders.</p>
						</marquee>
					</div>
				</div>
			</div>
			...
			<div class="top-panel-cover">
				<div class="top-panel-left">
					<ul class="header-cont">
						<li><a href="tel:+91 8919936547"><i class="fa fa-phone"></i>+91 8919 936 547</a></li>
